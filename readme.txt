=== Advanced Custom Fields: PHP to JSON Export ===
Contributors: Kevin Leary
Tags: acf php json export
...
1. Generate a *.json file using the "Custom Fields > Export PHP as JSON" menu item
